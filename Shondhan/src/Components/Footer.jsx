...
const Footer = () => {
  return (
    <footer className="bg-[#000022] text-white mt-auto">
      <div className="container mx-auto py-8 px-4">
        <div className="flex flex-col items-center text-center">

          <div className="mb-4">
            <img src="logo.svg" alt="Hope Bridge Logo" className="h-16 sm:h-20 object-contain mx-auto" />
          </div>
          ...
          <p className="text-sm mt-4">© 2024 All rights reserved by Shondhan</p>
        </div>
      </div>
    </footer>
  );
